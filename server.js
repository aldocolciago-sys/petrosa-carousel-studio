...
if (require.main === module) {
  server.listen(PORT, () => {
    ...
    console.log(`  Claude API: ${ANTHROPIC_KEY() ? 'attiva (' + MODEL() + ')' : 'NON configurata (modalita\' demo)'}`);
    console.log(`  Postiz:     ${POSTIZ_KEY() ? 'attivo' : 'NON configurato'}\n`);
  });
}
module.exports = { server, handler, loadAll, knowledgeBase, verifyQuotes };
